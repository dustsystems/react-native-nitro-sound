...
/**
 * Wraps a Swift `(_ event: String, _ detail: String) -> Void` as a class.
...
public final class Func_void_std__string_std__string {
  ...
  private let closure: (_ event: String, _ detail: String) -> Void

  public init(_ closure: @escaping (_ event: String, _ detail: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(event: std.string, detail: std.string) -> Void {
    self.closure(String(event), String(detail))
  }
