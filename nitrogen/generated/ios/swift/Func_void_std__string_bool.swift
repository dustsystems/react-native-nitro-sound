...
/**
 * Wraps a Swift `(_ text: String, _ isFinal: Bool) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_std__string_bool {
  public typealias bridge = margelo.nitro.sound.bridge.swift

  private let closure: (_ text: String, _ isFinal: Bool) -> Void

  public init(_ closure: @escaping (_ text: String, _ isFinal: Bool) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(text: std.string, isFinal: Bool) -> Void {
    self.closure(String(text), isFinal)
  }
