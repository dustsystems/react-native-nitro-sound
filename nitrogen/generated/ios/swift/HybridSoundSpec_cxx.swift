...
open class HybridSoundSpec_cxx {
  ...
  public final func crossfadeTo(uri: std.string, duration: bridge.std__optional_double_, targetVolume: bridge.std__optional_double_) -> bridge.Result_std__shared_ptr_Promise_std__string___ {
    do {
      let __result = try self.__implementation.crossfadeTo(uri: String(uri), duration: { () -> Double? in
        if bridge.has_value_std__optional_double_(duration) {
          let __unwrapped = bridge.get_std__optional_double_(duration)
          return __unwrapped
        } else {
          return nil
        }
      }(), targetVolume: { () -> Double? in
        if bridge.has_value_std__optional_double_(targetVolume) {
          let __unwrapped = bridge.get_std__optional_double_(targetVolume)
          return __unwrapped
        } else {
          return nil
        }
  ...
  public final func startAmbientLoop(uri: std.string, volume: Double, fadeDuration: bridge.std__optional_double_) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.startAmbientLoop(uri: String(uri), volume: volume, fadeDuration: { () -> Double? in
  ...
  public final func stopAmbientLoop(fadeDuration: bridge.std__optional_double_) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.stopAmbientLoop(fadeDuration: { () -> Double? in
        if bridge.has_value_std__optional_double_(fadeDuration) {
          let __unwrapped = bridge.get_std__optional_double_(fadeDuration)
          return __unwrapped
        } else {
  ...
  @inline(__always)
  public final func concatAudioFiles(inputPaths: bridge.std__vector_std__string_, outputPath: std.string) -> bridge.Result_std__shared_ptr_Promise_double___ {
    do {
      let __result = try self.__implementation.concatAudioFiles(inputPaths: inputPaths.map({ __item in String(__item) }), outputPath: String(outputPath))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_double__ in
        let __promise = bridge.create_std__shared_ptr_Promise_double__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_double__(__promise)
        __result
  ...
  @inline(__always)
  public final func startCommandRecognition() -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.startCommandRecognition()
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_void__ in
        let __promise = bridge.create_std__shared_ptr_Promise_void__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_void__(__promise)
        __result
  ...
  @inline(__always)
  public final func stopCommandRecognition() -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.stopCommandRecognition()
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_void__ in
        let __promise = bridge.create_std__shared_ptr_Promise_void__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_void__(__promise)
        __result
  ...
  @inline(__always)
  public final func setCommandResultCallback(callback: bridge.Func_void_std__string_bool) -> bridge.Result_void_ {
    do {
      try self.__implementation.setCommandResultCallback(callback: { () -> (String, Bool) -> Void in
  ...
  @inline(__always)
  public final func removeCommandResultCallback() -> bridge.Result_void_ {
    do {
      try self.__implementation.removeCommandResultCallback()
      return bridge.create_Result_void_()
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_void_(__exceptionPtr)
  ...
  @inline(__always)
  public final func liveTranscriptionSupported() -> bridge.Result_bool_ {
    do {
      let __result = try self.__implementation.liveTranscriptionSupported()
  ...
  @inline(__always)
  public final func ensureLiveTranscriptionAssets(locale: std.string) -> bridge.Result_std__shared_ptr_Promise_std__string___ {
    do {
      let __result = try self.__implementation.ensureLiveTranscriptionAssets(locale: String(locale))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__string__ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__string__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__string__(__promise)
        __result
  ...
  @inline(__always)
  public final func startLiveTranscription(locale: std.string) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.startLiveTranscription(locale: String(locale))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_void__ in
        let __promise = bridge.create_std__shared_ptr_Promise_void__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_void__(__promise)
        __result
  ...
  @inline(__always)
  public final func stopLiveTranscription() -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.stopLiveTranscription()
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_void__ in
        let __promise = bridge.create_std__shared_ptr_Promise_void__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_void__(__promise)
        __result
  ...
  @inline(__always)
  public final func setLiveTranscriptionResultCallback(callback: bridge.Func_void_std__string_bool) -> bridge.Result_void_ {
    do {
      try self.__implementation.setLiveTranscriptionResultCallback(callback: { () -> (String, Bool) -> Void in
        let __wrappedFunction = bridge.wrap_Func_void_std__string_bool(callback)
        return { (__text: String, __isFinal: Bool) -> Void in
          __wrappedFunction.call(std.string(__text), __isFinal)
        }
  ...
  @inline(__always)
  public final func removeLiveTranscriptionResultCallback() -> bridge.Result_void_ {
    do {
      try self.__implementation.removeLiveTranscriptionResultCallback()
      return bridge.create_Result_void_()
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_void_(__exceptionPtr)
  ...
  @inline(__always)
  public final func setLiveTranscriptionErrorCallback(callback: bridge.Func_void_std__string_std__string) -> bridge.Result_void_ {
    do {
      try self.__implementation.setLiveTranscriptionErrorCallback(callback: { () -> (String, String) -> Void in
  ...
  @inline(__always)
  public final func removeLiveTranscriptionErrorCallback() -> bridge.Result_void_ {
    do {
      try self.__implementation.removeLiveTranscriptionErrorCallback()
      return bridge.create_Result_void_()
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_void_(__exceptionPtr)
  ...
  @inline(__always)
  public final func startSleepCapture(configJson: std.string) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.startSleepCapture(configJson: String(configJson))
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_void__ in
        let __promise = bridge.create_std__shared_ptr_Promise_void__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_void__(__promise)
        __result
  ...
  @inline(__always)
  public final func stopSleepCapture() -> bridge.Result_std__shared_ptr_Promise_std__string___ {
    do {
      let __result = try self.__implementation.stopSleepCapture()
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__string__ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__string__()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__string__(__promise)
        __result
  ...
  @inline(__always)
  public final func isSleepCaptureActive() -> bridge.Result_bool_ {
    do {
      let __result = try self.__implementation.isSleepCaptureActive()
      let __resultCpp = __result
      return bridge.create_Result_bool_(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
  ...
  @inline(__always)
  public final func setSleepEpisodeCallback(callback: bridge.Func_void_std__string) -> bridge.Result_void_ {
    do {
      try self.__implementation.setSleepEpisodeCallback(callback: { () -> (String) -> Void in
        let __wrappedFunction = bridge.wrap_Func_void_std__string(callback)
        return { (__episodeJson: String) -> Void in
          __wrappedFunction.call(std.string(__episodeJson))
        }
      }())
      return bridge.create_Result_void_()
    } catch (let __error) {
  ...
  @inline(__always)
  public final func getSleepCaptureStats() -> bridge.Result_std__string_ {
    do {
      let __result = try self.__implementation.getSleepCaptureStats()
      let __resultCpp = std.string(__result)
      return bridge.create_Result_std__string_(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
