...
/**
 * Represents the JavaScript callback `(text: string, isFinal: boolean) => void`.
...
fun interface Func_void_std__string_bool: (String, Boolean) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(text: String, isFinal: Boolean): Unit
}
...
class Func_void_std__string_bool_cxx: Func_void_std__string_bool {
  ...
  @Keep
  override fun invoke(text: String, isFinal: Boolean): Unit
    = invoke_cxx(text,isFinal)

  @FastNative
  private external fun invoke_cxx(text: String, isFinal: Boolean): Unit
}
...
class Func_void_std__string_bool_java(private val function: (String, Boolean) -> Unit): Func_void_std__string_bool {
  ...
  @Keep
  override fun invoke(text: String, isFinal: Boolean): Unit {
    return this.function(text, isFinal)
  }
}
