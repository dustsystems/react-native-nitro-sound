...
namespace margelo::nitro::sound {
  ...
  std::shared_ptr<Promise<void>> JHybridSoundSpec::installTap() {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("installTap");
    auto __result = method(_javaPart);
    return [&]() {
      auto __promise = Promise<void>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& /* unit */) {
  ...
  std::shared_ptr<Promise<void>> JHybridSoundSpec::removeTap() {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("removeTap");
    auto __result = method(_javaPart);
    return [&]() {
      auto __promise = Promise<void>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& /* unit */) {
  ...
  std::shared_ptr<Promise<void>> JHybridSoundSpec::fadeVolumeTo(double targetVolume, double duration) {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(double /* targetVolume */, double /* duration */)>("fadeVolumeTo");
  ...
  void JHybridSoundSpec::writeDebugLogSummary() {
    static const auto method = javaClassStatic()->getMethod<void()>("writeDebugLogSummary");
    method(_javaPart);
  }
