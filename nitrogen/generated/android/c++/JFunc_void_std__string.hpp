...
namespace margelo::nitro::sound {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/sound/Func_void_std__string;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/sound/Func_void_std__string_cxx;";
